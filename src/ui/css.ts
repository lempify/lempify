...
export const buttonWithArrow =
  'hover:text-black dark:hover:text-white before:content-["﹥"] before:mr-1 before:relative before:inline-flex before:text-[90%]  hover:before:translate-x-1 before:transition-transform before:duration-200 before:ease-in-out';
