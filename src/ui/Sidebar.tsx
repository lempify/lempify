...
export default function Sidebar() {
    return (
        <aside className="sticky top-0 z-1 h-screen bg-neutral-100 dark:bg-neutral-900 text-neutral-600 dark:text-white border-r border-neutral-300 dark:border-neutral-700">
